...
import ClassAndConstructors.MyClass;

public class MethodTakingArguments {
    ...
    void printMyArray(int[] ar) {
        System.out.println("===== Array is printing ====="); // Single dimensional
        for (int i = 0; i < ar.length; i++)
            System.out.println(ar[i]);
    }

    void printTwoDArray(String[][] myTwoDArray) {
        System.out.println("===== Two D Array is printing ====="); // Two dimensional
    ...
    public static void main(String[] args) {
        ...
        MethodTakingArguments ob = new MethodTakingArguments();
